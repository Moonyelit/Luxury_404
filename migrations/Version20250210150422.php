 ...
 */
final class Version20250210150422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate ADD experience_id INT DEFAULT NULL, ADD job_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidate DROP experience_id, DROP job_category_id');
    }
}
